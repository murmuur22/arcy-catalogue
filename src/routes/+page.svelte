...
<enhanced:img src="/bg-left.png" class="absolute left-0 w-screen" alt="background">
<enhanced:img src="/bg-right.png" class="absoliute right-0 w-screen" alt="background">
...
<div out:fade={{duration: 800}} class="fixed left-0 top-0 h-screen w-screen flex justify-center items-center">
    <enhanced:img src={images[curr_image]} class="h-5/6 pointer-events-none" alt="rotator">
</div>
...
<div  id="vidWrapper" class="fixed left-0 top-0 h-screen w-screen flex justify-center items-center">
    ...
    <enhanced:img id="arcteryx" alt="gore-tex" src="/graphics/arcteryx.png" class="pointer-events-none opacity-0 fixed w-1/6"/>
    <enhanced:img id="goretex" alt="gore-tex" src="/graphics/gore-tex.png" class="pointer-events-none opacity-0 fixed w-1/6"/>
</div>
{/if}